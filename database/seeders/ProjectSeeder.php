...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $projects = [
            ...
            [
                'name' => 'Bridge Construction - Barangay Aquino',
                'project_code' => 'BC-SM-2025-006',
                'description' => 'Construction of a new concrete bridge over Aquino River to improve access for residents and emergency vehicles.',
                ...
                'cost' => null,
                'source' => 'LGU Infrastructure Fund',
                'location' => 'Barangay Aquino, Tangub City',
                'engineer' => 6,
                'contructor' => 6,
                'category' => 'Bridges',
                'priority' => 'High',
