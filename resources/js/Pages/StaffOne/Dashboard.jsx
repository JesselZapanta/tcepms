...
export default function Dashboard({ auth }) {
    ...
    const getData = async () => {
        setLoading(true);
        try {
            const res = await axios.get("/staffone/dashboard/getdata");
    ...
    return (
        <AuthenticatedLayout header="Staff One Dashboard" auth={auth}>
            <Head title="Staff One Dashboard" />
                    ...
                    <div className="bg-white m-4 p-4 rounded flex">
                        ...
                        <div>
                            ...
                            <p className="text-sm italic">
                                You are logged in as Staff (Project and Materials Division)
                            </p>
                        </div>
                    </div>
