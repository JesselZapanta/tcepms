...
class EngineerProjectMonitoringController extends Controller
{
    ...
    //     //this has a updates relation
    //     //get the latest ProjectUpdate sort, show what project has the latest and oldest project update based on $request->order
    //     ->paginate(10);
    // }
    ...
    public function getData(Request $request)
    {
        ...
        return Project::with([
            ...
            ->where('projects.engineer', Auth::user()->id)
